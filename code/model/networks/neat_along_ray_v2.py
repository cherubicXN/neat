...
class VolSDFNetwork(nn.Module):
    def __init__(self, conf):
        ...
        self.neat_sdf = ImplicitNetwork(self.feature_vector_size, 0.0 if self.white_bkgd else self.scene_bounding_sphere, **conf.get_config('implicit_network'))
    ...
    def forward(self, input):
        ...
        sdf_a = self.neat_sdf.get_sdf_vals(lines3d_a.detach())
        sdf_b = self.neat_sdf.get_sdf_vals(lines3d_b.detach())

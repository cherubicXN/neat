...
class VolSDFNetwork(nn.Module):
    ...
    def forward(self, input):
        ...
        lines3d, lines_emb = self.attraction_network.forward(points3d, points_gradients, points_features)
        ...
        embedding_mean = torch.empty_like(lines_emb)
        ...
        if self.training:
            ...
            for lb in label_set:
                ...
                embedding_mean[idx_sel] = emb_i
                # emb_var.append(lines_emb[idx_sel].var(dim=0))

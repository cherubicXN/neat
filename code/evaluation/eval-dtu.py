...
if __name__ == '__main__':
    ...
    if args.mode == 'mesh':
        ...
        with mp.Pool(16) as mp_pool:
            new_pts = mp_pool.map(sample_single_tri, ((n1[i,0], n2[i,0], v1[i:i+1], v2[i:i+1], tri_vert[i:i+1,0]) for i in range(len(n1))), chunksize=args.chunksize)
    ...
    outpath = args.data[:-4]+'.txt'
    with open(outpath,'w') as f:
        f.writelines('{}\t{}\t{}'.format(mean_d2s, mean_s2d, over_all))

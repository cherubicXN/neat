...
class VolSDFNetwork(nn.Module):
    def __init__(self, conf):
        ...
        self.center_net = CenterNetwork(self.feature_vector_size, 6, 6, dims = [256])
    ...
    def forward(self, input):
        ...
        csdf, cfeat, cgrads = self.implicit_network.get_outputs(centers.detach())
        # lines3d_aux = self.center_net(centers.detach(),cgrads.detach(), cfeat.detach())
